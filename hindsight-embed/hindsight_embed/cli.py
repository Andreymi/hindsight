...
# Provider defaults: (provider_id, default_model, env_key_name, default_base_url)
PROVIDER_DEFAULTS = {
    "openai": ("openai", "o3-mini", "OPENAI_API_KEY", None),
    "openai-compatible": ("openai", "gpt-oss:120b-cloud", None, "https://ollama.com/v1"),
    "groq": ("groq", "openai/gpt-oss-20b", "GROQ_API_KEY", None),
    "google": ("google", "gemini-2.0-flash", "GOOGLE_API_KEY", None),
    "ollama": ("ollama", "llama3.2", None, "http://localhost:11434/v1"),
}
...
def _do_configure_from_env():
    ...
    # Check for API key (required for non-ollama/non-openai-compatible providers)
    if not api_key and provider not in ("ollama", "openai-compatible"):
