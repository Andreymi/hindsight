...
/// Only animates when stdout is a terminal; silent in non-interactive mode.
...
impl GradientSpinner {
    pub fn new(message: &str) -> Self {
        ...
        // Only start animation thread if stdout is a terminal
        let handle = if is_interactive {
    ...
    pub fn finish(&mut self) {
        ...
        // Clear the line only in interactive mode
